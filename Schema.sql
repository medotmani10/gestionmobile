...
ALTER TABLE public.clients ADD COLUMN IF NOT EXISTS phone TEXT, ADD COLUMN IF NOT EXISTS email TEXT, ADD COLUMN IF NOT EXISTS address TEXT, ADD COLUMN IF NOT EXISTS notes TEXT, ADD COLUMN IF NOT EXISTS total_projects INTEGER DEFAULT 0, ADD COLUMN IF NOT EXISTS total_debt DECIMAL(12,2) DEFAULT 0, ADD COLUMN IF NOT EXISTS created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW();
...
ALTER TABLE public.suppliers ADD COLUMN IF NOT EXISTS phone TEXT, ADD COLUMN IF NOT EXISTS address TEXT, ADD COLUMN IF NOT EXISTS material_type TEXT, ADD COLUMN IF NOT EXISTS notes TEXT, ADD COLUMN IF NOT EXISTS total_purchases DECIMAL(12,2) DEFAULT 0, ADD COLUMN IF NOT EXISTS created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW();

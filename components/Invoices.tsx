    ...
    try {
      ...
      const htmlContent = `
        ...
        <body>
          ...
          <div class="footer">
            <p>شكراً لتعاملكم معنا | تم استخراج هذه الفاتورة إلكترونياً</p>
          </div>
          <script>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col xl:flex-row gap-6 justify-between items-start xl:items-center bg-white p-6 rounded-3xl border border-slate-100 shadow-sm">
        ...
        <div className="flex flex-wrap gap-3 w-full xl:w-auto">
          ...
          <button 
            ...
            className="flex items-center gap-2 px-5 py-2.5 bg-blue-600 text-white rounded-xl text-xs font-bold shadow-lg shadow-blue-500/20 hover:bg-blue-700 transition-all"
          >
            <Plus size={16} />
            فاتورة جديدة
          </button>
      ...
      <div className="bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden min-h-[500px] flex flex-col">
        ...
        {loading ? (
           <div className="flex flex-1 justify-center items-center"><Loader2 className="animate-spin text-blue-600" size={32} /></div>
        ) : (
            ...
            <div className="p-6 border-t border-slate-100 bg-slate-50/50 flex flex-col md:flex-row justify-between items-center gap-6">
              <div className="flex gap-8 text-right w-full md:w-auto">
                ...
                <div className="border-r border-slate-200 pr-8">
                  <p className="text-[10px] font-bold text-blue-600 uppercase">الصافي (TTC)</p>

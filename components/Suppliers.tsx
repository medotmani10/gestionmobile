...
const Suppliers: React.FC = () => {
  ...
  async function fetchSuppliers() {
    try {
      ...
      // 3. Fetch Transactions (Payments) - Assuming payments are expenses with description containing supplier name
      // Note: In a stricter schema, we would link transaction to supplier_id. Here we use name matching or description logic.
      // We will assume transactions with category 'supplier_payment' and description containing name.

            ...
            <form onSubmit={handleSave} className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1">
                  ...
                  <input required placeholder="مثال: إسمنت مقاوم" className="w-full p-3 bg-slate-50 border rounded-xl text-sm" 
                ...
                <div className="space-y-1">
                  ...
                  <input required placeholder="مثال: 50 كيس" className="w-full p-3 bg-slate-50 border rounded-xl text-sm" 
              ...
              <div className="grid grid-cols-2 gap-4">
                 <div className="space-y-1">
                    ...
                    <input type="number" required className="w-full p-3 bg-slate-50 border rounded-xl text-sm font-bold" 
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                   <input list="suppliers_list" required className="w-full p-3 bg-slate-50 border rounded-xl text-sm" 
              ...
              <div className="space-y-1">
                ...
                <select required className="w-full p-3 bg-slate-50 border rounded-xl text-sm" 
              ...
              <div className="space-y-1">
                ...
                <select className="w-full p-3 bg-slate-50 border rounded-xl text-sm" 

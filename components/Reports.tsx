      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-slate-900 p-10 rounded-[40px] shadow-2xl text-white relative overflow-hidden group">
           <div className="relative z-10">
              ...
              <p className="text-slate-400 text-sm mb-10 leading-loose">
                بناءً على المعطيات الحقيقية لـ {reportData.activeCount} مشاريع، نلاحظ أن معدل الإنجاز ({reportData.avgProgress}%) يتماشى مع المصاريف التشغيلية. 
                النظام الجزائري "بناء برو" يقترح عليك موازنة المشتريات لتقليل تكاليف المواد في الربع القادم.
              </p>
              <div className="grid grid-cols-2 gap-4">
                 <div className="p-4 bg-white/5 rounded-2xl border border-white/10 group-hover:bg-white/10 transition-all">
                    ...
                    <p className="text-xs font-medium">استقرار مالي جيد جداً</p>
                 </div>
                 <div className="p-4 bg-white/5 rounded-2xl border border-white/10 group-hover:bg-white/10 transition-all">
                    <p className="text-[10px] text-green-400 font-bold mb-1">التوصية</p>
                    <p className="text-xs font-medium">تسريع وتيرة الإنجاز</p>
                 </div>
              </div>
           </div>

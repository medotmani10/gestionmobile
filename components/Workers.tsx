        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm">
          <div className="bg-white w-full max-w-md rounded-3xl shadow-2xl p-6">
            ...
            <form onSubmit={handleSaveWorker} className="space-y-4">
              <input required placeholder="اسم العامل" className="w-full p-3 bg-slate-50 border rounded-xl" value={formData.name} onChange={e => setFormData({...formData, name: e.target.value})} />
              <input required placeholder="التخصص" className="w-full p-3 bg-slate-50 border rounded-xl" value={formData.trade} onChange={e => setFormData({...formData, trade: e.target.value})} />
              <div className="grid grid-cols-2 gap-4">
                 ...
                 <input type="number" required placeholder="اليومية" className="w-full p-3 bg-slate-50 border rounded-xl" value={formData.daily_rate} onChange={e => setFormData({...formData, daily_rate: Number(e.target.value)})} />
              </div>
              <div>
